...
# my modules
from pyldraw.support.imgutils import *
...
def test_image_crop_fit():
    ...
    ImageMixin.save_image(IMG_PATH + "cropfit1.png", img3)
    ...
    ImageMixin.save_image(IMG_PATH + "cropfit2.png", img4)
...
def test_count_trans():
    ...
    ImageMixin.save_image(IMG_PATH + "count.png", img2)
    ...
    c2 = ImageMixin.count_transparent_pixels(IMG_PATH + "count.png")
    assert counts == c2
...
def test_crop_content():
    ...
    ImageMixin.save_image(IMG_PATH + "cropped_to_contents.png", img2)
    ...
    ImageMixin.save_image(IMG_PATH + "cropped_to_contents_h.png", img3)
    assert img3.shape == (425, 640, 3)
    img4 = ImageMixin.crop_to_content(img1, widthwise=True, heightwise=False)
    ImageMixin.save_image(IMG_PATH + "cropped_to_contents_w.png", img4)
...
def test_colour_convert():
    bgr1 = (128, 0, 0)
    hsv1 = ImageMixin.bgr2hsv(bgr1)
    assert hsv1 == (120, 255, 128)

    bgr1 = (255, 0, 0)
    hsv1 = ImageMixin.bgr2hsv(bgr1)
    assert hsv1 == (120, 255, 255)

    bgr1 = (0, 255, 0)
    hsv1 = ImageMixin.bgr2hsv(bgr1)
    assert hsv1 == (60, 255, 255)

    bgr1 = (0, 0, 255)
    hsv1 = ImageMixin.bgr2hsv(bgr1)
    assert hsv1 == (0, 255, 255)

    bgr1 = (0, 128, 128)
    hsv1 = ImageMixin.bgr2hsv(bgr1)
    assert hsv1 == (30, 255, 128)
